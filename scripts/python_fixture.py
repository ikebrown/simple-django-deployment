...
home_page = api.create_page('Home', 'base_templates/front.html', 'en', menu_title='Home', created_by=user, in_navigation=False, published=True)
api.create_title('nb', 'Hjem', home_page, menu_title='Hjem')
search_page = api.create_page('Search', 'base_templates/default.html', 'en', menu_title='Search', apphook='DjangoCmsFacetedSearchApphook', created_by=user, in_navigation=False, published=True, reverse_id='search')
